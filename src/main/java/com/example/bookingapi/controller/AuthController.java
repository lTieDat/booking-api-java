...
public class AuthController {
    ...
    @CommonApiResponses
    public ResponseEntity<com.example.bookingapi.payload.response.ApiResponse> registerUser(@Valid @RequestBody SignUpRequest signUpRequest) {
        com.example.bookingapi.payload.response.ApiResponse apiResponse = authService.signup(signUpRequest);
    ...
    @ApiResponse(responseCode = "200", description = "Email verification OTP generated successfully.",
    ...
    @ApiResponse(responseCode = "200", description = "Email verified successfully.",
            content = @Content(schema = @Schema(implementation = com.example.bookingapi.payload.response.ApiResponse.class)))
    @CommonApiResponses
    public ResponseEntity<com.example.bookingapi.payload.response.ApiResponse> verifyEmail(@Valid @RequestBody OtpVerifyRequest otpVerifyRequest) {
    ...
    @ApiResponse(responseCode = "200", description = "Password reset OTP generated successfully.",
            content = @Content(schema = @Schema(implementation = OtpTokenResponse.class)))
    @CommonApiResponses
    ...
    @ApiResponse(responseCode = "200", description = "Password reset successfully.",
            content = @Content(schema = @Schema(implementation = com.example.bookingapi.payload.response.ApiResponse.class)))
    @CommonApiResponses
    public ResponseEntity<com.example.bookingapi.payload.response.ApiResponse> resetPassword(@Valid @RequestBody PasswordResetConfirmRequest request) {
