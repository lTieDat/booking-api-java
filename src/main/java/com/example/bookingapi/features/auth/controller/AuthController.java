package com.example.bookingapi.features.auth.controller;
...
public class AuthController {
    ...
    public ResponseEntity<ApiMessageResponse> registerUser(@Valid @RequestBody SignUpRequest signUpRequest) {
        ApiMessageResponse apiResponse = authService.signup(signUpRequest);
    ...
    @ApiResponse(responseCode = "200", description = "Email verified successfully.",
            content = @Content(schema = @Schema(implementation = ApiMessageResponse.class)))
    @CommonApiResponses
    public ResponseEntity<ApiMessageResponse> verifyEmail(@Valid @RequestBody OtpVerifyRequest otpVerifyRequest) {
    ...
    @ApiResponse(responseCode = "200", description = "Password reset successfully.",
            content = @Content(schema = @Schema(implementation = ApiMessageResponse.class)))
    @CommonApiResponses
    public ResponseEntity<ApiMessageResponse> resetPassword(@Valid @RequestBody PasswordResetConfirmRequest request) {
